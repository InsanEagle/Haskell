Анкета для студентов института компьютерных наук
   ...
   Укажите номер курса, на котором Вы учитесь: 1
...
пользуя:
   (1) встроенные в язык типы данных (без подключения библиотек); Haskell, Pascal
...
вида источника информации:
   (1) страницы Интернета; 30% 
   (2) электронный вариант книг на русском языке; 25%
   (3) электронный вариант книг на английском (или другом иностран-
ном) языке;
   (4) электронный вариант статей на русском языке; 5%
...
ном) языке;
   (10) электронный вариант материалов преподавателей. 40%
...
3)	Прикладные задачи теоретического программирования
